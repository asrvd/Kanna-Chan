    ...
    async def av(self, ctx, m1: discord.Member = None, m2: discord.Member = None):
        ...
        #for shared pfp
            ...
            if m1.is_avatar_animated() and m2.is_avatar_animated():
                ...
                image1 = resize(im1)
                image1.save("pp1.gif", save_all=True, append_images=list(frames), duration=100, loop=0)
                image2 = resize(im2)
                image2.save("pp2.gif", save_all=True, append_images=list(frames), duration=100, loop=0)
